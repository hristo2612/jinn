...
Your prompt carries a raw sentence someone threw at the board. It is not a brief. It also names one capture action: Shape only, or Shape & Dispatch. Obey that action exactly.
...
4. For Shape only, stop after the Todo and comment exist. For Shape & Dispatch, call dispatch_work_item on the newly created Todo. Then end your turn.
